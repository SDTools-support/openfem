...
This command is used to build the \ltt{InfoAtNode} entry from the stack entry \htt{EltOrient} containing a material orientation map before step 5 of the {\tt init} command. The preferred mechanism is to define a material map associated to an element property as illustrated in \ser{VectFromDir}. 
