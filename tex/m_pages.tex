...
%       $Revision: 1.73 $  $Date: 2026/02/25 18:35:15 $
...
\begin{itemize}
\item material bases defined for each element \ltt{EltOrient} or each property \ltt{Coordm}.
\item orientation maps used for material handling are described in~\ser{VectFromDir}. It is then expected that the six components {\tt v1x,v1y,v1z,v2x,v2y,v2z} are stored sequentially in the interpolation table.
\end{itemize}
