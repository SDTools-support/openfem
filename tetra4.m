...
if comstr(CAM,'cvs')
 out='$Revision: 1.39 $  $Date: 2019/04/12 05:54:23 $'; return;
end
...
if ischar(CAM)
 ...
 if comstr(Cam,'integinfo')
  ...
  [out,out1,out2]=p_solid('buildconstit 3 4',varargin{1:end});
 ...
 elseif comstr(Cam,'constants');
  ...
  elseif varargin{2}(size(varargin{2},1),1)==-9999; % old of_mk_sub.c elements
   ...
   [out,i2,out2]=p_solid('constsolid','tetra4',varargin{2:end});
 ...
 elseif  comstr(Cam,'face')||comstr(Cam,'patch');   
     out = [1 3 2; 1 4 3; 1 2 4; 2 3 4];
 elseif  comstr(Cam,'flip'); out=[1 3 2 4]; out1=[1 2 3 4]; %  out=[2 3]; out1=[3 2]; 
