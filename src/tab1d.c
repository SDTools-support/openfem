/* tab1d.f -- translated by f2c (version 19961017).
...
/* Subroutine */ int tab1d_(i1, i2, i3, a, b, c__)
int32 *i1, *i2, *i3;
doublereal *a, *b, *c__;
{
...
/*                        ---------- */
/* ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
/* BUT : C = C + TA * B OU  C(I1,I3),A(I2,I1),B(I2,I3) */
/* ---- */
/* PARAMETRES D ENTREE : */
/* --------------------- */
/* I1  : NOMBRE DE LIGNES DE C ET DE COLONNES DE A */
